...
class student_course_materials extends StatefulWidget {
  var cname;
  var ccode;

  student_course_materials(this.cname, this.ccode);
  State<StatefulWidget> createState() {
    return student_course_materialsstate(this.cname, this.ccode);
  }
}

class student_course_materialsstate extends State<student_course_materials> {
  var cname;
  var ccode;

  student_course_materialsstate(this.cname, this.ccode);
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Container(
              margin: EdgeInsets.only(top: displayWidth(context) * 0.28),
