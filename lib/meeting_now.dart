...
class meeting_now extends StatefulWidget {
  State<StatefulWidget> createState() {
    return meeting_nowstate();
  }
}

class meeting_nowstate extends State<meeting_now> {
  final _localRenderer = RTCVideoRenderer();
  final List<RTCVideoRenderer> _remoteRenderers = <RTCVideoRenderer>[];
  final Connector _connector = Connector('http://192.168.1.5:5551');
  final _room = 'ion';
  final _uid = Uuid().v4();
  late RTC _rtc;
  @override
