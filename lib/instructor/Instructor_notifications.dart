...
class Instructor_notifications extends StatefulWidget {
  State<StatefulWidget> createState() {
    return Instructor_notificationsstate();
  }
}

class Instructor_notificationsstate extends State<Instructor_notifications> {
  @override
