...
class Instructor_dashboard extends StatefulWidget {
  String currentUser;
  Instructor_dashboard(this.currentUser);
  State<StatefulWidget> createState() {
    return Instructor_dashboardstate(this.currentUser);
  }
}

class Instructor_dashboardstate extends State<Instructor_dashboard> {
  String currentUser;
  Instructor_dashboardstate(this.currentUser);
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(displayWidth(context) * -0.0015, -0.050),
            child: Text(
              'Latest Uploaded Assignments',
              style: TextStyle(
                fontFamily: 'Gilroy',
                fontSize: 20,
