...
import './Instructor_exam_form_a.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:svu_beta/sizehelper.dart';
class Instructor_exam_form_q extends StatelessWidget {
  Instructor_exam_form_q({
    Key? key,
  }) : super(key: key);
  @override
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Instructor_addexam(),
                ),
              ],
              child: Container(
                decoration: BoxDecoration(
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Instructor_exam_form_a(),
                ),
              ],
              child: Container(
                decoration: BoxDecoration(
