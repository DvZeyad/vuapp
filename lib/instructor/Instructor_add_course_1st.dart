...
import 'package:svu_beta/instructor/Instructor_courses.dart';
import 'package:svu_beta/sizehelper.dart';
import 'package:flutter/material.dart';
import 'package:adobe_xd/pinned.dart';
import 'package:awesome_dialog/awesome_dialog.dart';
//import './Instructor_add_course_2nd.dart';

class Instructor_add_course_1st extends StatefulWidget {
  State<StatefulWidget> createState() {
    return Instructor_add_course_1ststate();
  }
}

class Instructor_add_course_1ststate extends State<Instructor_add_course_1st> {
  final coursename = TextEditingController();
  final courseyear = TextEditingController();
  ...
  Future<void> sendData() async {
    ...
    try {
      var res = await conn.execute(
          "insert into courses(coursecode,coursename,year,course_description,course_accesscode,duration) values ('$coursecodeT','$coursenameT','$courseyearT','$coursedescT','$accesscodeT',$coursedurationT)");
      AwesomeDialog(
        context: context,
        ...
        title: 'Success',
        desc: 'Your Course Has Been Added Successfuly',
        btnOkOnPress: () {
          Navigator.pop(
            context,
          );
